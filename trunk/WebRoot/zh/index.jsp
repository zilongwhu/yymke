			    ...
			    <tr valign="top">
			      ...
			      <td width="">
			      	<table width="100%" border="0">
				        <tr>
				          <td><div style="width:92% auto; height:20px; position:relative;background-image:url(images/c.gif); background-repeat:no-repeat; background-color:#E1E2E6; margin-left:3px;"></div></td>
				        </tr>
				        <tr>
				          <td style="text-align:left; line-height:200%; padding-left:8px;">
				          	&nbsp;&nbsp;&nbsp;&nbsp;岳阳明科电气有限公司是按照现代企业制度创立的股份制企业,在消化原引进日本技术的基础上，加大与欧美同行的技术交流与合作，不断创新，将电磁、永磁、电缆卷筒上的科研成果和技术优势转化为产品的核心竞争力，产品国际市场的开拓一直走在行业的前列。公司在欧盟、日本、马来西亚、新加坡、泰国设有代表处。产品已出口到世界各地，涵盖35个国家和地区，是目前国内最大的起重电磁铁、电磁除铁器的出口企业。<a style="color: #FF7D42; text-decoration: underline;" href="company.jsp">了解更多</a><br />
						  </td>
				        </tr>
				        <tr>
				        ...
				        <tr>
				          <td>
				          	<table width="100%" border="0">
					            <tr>
					              <td><a href="product.jsp?id=1"><img src="images/p_1.jpg" border="0" width="300" height="66" /></a></td>
					              <td><a href="product.jsp?id=8"><img src="images/p_2.jpg" border="0" alt="" width="300" height="66" /></a></td>
					            </tr>
					            <tr valign="top">
					              <td style="text-align:left; line-height:200%; padding-left:13px; padding-right:10px; font-size:13px;">
					              	<strong><img src="images/xx.png" width="25" height="17" /><a href="product.jsp?id=1">起重电磁铁及电控系列</a></strong><br />                
					              	&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:12px"><a href="product.jsp?id=1">吊运废钢用起重电磁铁；吊运钢坯、板坯用起重电磁铁；板坯吊运翻转用起重电磁铁；吊运钢锭、钢坯用起重电磁铁；吊运初扎钢、型钢用起重电磁铁；吊运钢坯、圆钢用起重电磁铁</a></span>......
					              </td>
						          <td style="text-align:left; line-height:200%; padding-left:13px; padding-right:6px; font-size:13px;">
						          	<strong><img src="images/xx.png" alt="" width="25" height="17" /><a href="product.jsp?id=8">除铁器及电控系列</a></strong><br />                
						            &nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:12px"><a href="product.jsp?id=8">MC03系列圆形电磁除铁器；MC23系列矩形电磁除铁器；MC22系列自卸式电磁除铁器；MC12系列自卸式电磁除铁器；MC12系列节能型自卸式电磁除铁器；RCDD-Q系列超强新型风冷自卸式电磁除铁器</a></span>......
						          </td>
					            </tr>
					            <tr>
					          	  <td>&nbsp;</td>
					            ...
					            <tr>
					              <td style="text-align:left; line-height:200%; padding-left:13px; padding-right:10px;">
					              	<strong><img src="images/xx.png" alt="" width="25" height="17" /><a href="product.jsp?id=9">电缆卷筒系列</a></strong><br />                
					                &nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:12px"><a href="product.jsp?id=9">弹力、力矩电机式电缆卷筒；弹力电缆卷筒滑环内装式；弹力电缆卷筒水平地面卷取式；弹力电缆卷筒滑环外装式；弹力电缆卷筒悬臂式；电缆卷筒信号式；电缆卷筒力矩电机式；重锤式电缆卷筒</a><span style="text-align:left; line-height:200%; padding-left:0px; padding-right:10px; font-size:13px;">......</span></span>
					              </td>
					              <td style="text-align:left; line-height:200%; padding-left:13px; padding-right:6px;">
					              	<strong><img src="images/xx.png" alt="" width="25" height="17" /><a href="product.jsp?id=70"><a href="product.jsp?id=70">连铸电磁搅拌装置系列</a></strong><br />
					                <span style="text-align:left; line-height:200%; padding-left:13px; padding-right:10px;">&nbsp;</span><a href="product.jsp?id=70">结晶器外置式电磁搅拌器(内冷)；结晶器外置式电磁搅拌器(外冷)；结晶器内置式电磁搅拌器(外冷)；结晶器内置式电磁搅拌器(模块)；结晶器内置式电磁搅拌器(两相两极)；双线圈结晶器电磁搅拌器</a><span style="text-align:left; line-height:200%; padding-left:0px; padding-right:10px; font-size:13px;">......</span>
					              </td>
					            </tr>
					        </table>
				          </td>
