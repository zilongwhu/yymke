...
<table width="100%" border="0" height="100%">
        <tr>
          <td valign="top"><table height="70" width="100%" border="0">
            <tr>
              <td> <b><font face="黑体" size="3">产品概述</font></b></td>
            </tr>
            <tr>
              <td>
				<p align="left">
				&nbsp;&nbsp;&nbsp; 
				电磁除铁器是一种产生强大磁场吸引力的设备，它能将混杂在物料中的铁磁性杂质清除，以保证输送系统中的破碎机、研磨机等机械设备安全正常的工作，同时可有效地防止因大、长铁件划裂输送机皮带的事故发生，亦可显著提高原料品位。<br>
&nbsp;&nbsp;&nbsp; 
				我公司生产的除铁器按其安装形式可统称为悬挂式电磁除铁器，按其卸铁的方式分为人工卸铁、自动卸铁和程序控制卸铁等多种工作方式。由于使用场合和磁路结构不同，形成了各种系列产品。除去铁磁性杂物的范围从微粒至80公斤。<br>
&nbsp;&nbsp;&nbsp; 
				电磁除铁器广泛用于冶金、矿山、选煤厂、电厂、陶瓷、玻璃、水泥、建材、化工、食品及饲料加工行业。在新兴的垃圾处理工业中，也需要运用电磁除铁器回收废物中的钢铁。我公司生产的各种除铁器已在全国各大型钢铁企业，以及金属矿山、电厂、轻工、耐火材料等行业使用，并发挥着巨大作用。</td>
            </tr>
          	<tr>
              <td>
				<div>
					<table cellpadding="0" cellspacing="0">
						...
						<tr>
							<td valign="top"><b>
							<font size="2">产品特点：</font></b><br>
							1、采用全密封自然冷却结构，能防止潮湿空气，粉尘和有害气体对线圈的侵蚀，对气候及环境的适应型强，户内、户外均可使用。<br>
							2、磁路经特殊设计，透磁深度大，并且空间磁场的几何形状为近似矩形的半球状。因此较其它同类产品有更强的吸引力。<br>
							3、以安装在带式输送机中部位置，确定产品的除铁能力。如果将去安装在机头位置使用，除铁能力可提高30％。<br>
							4、以热态电流时除铁能力作为考核产品性能的重要指标，这样更切合实际，更能有效地发挥除铁器的作用。<br>
							5、产品配套性能好，各种整流设备功能齐备，能适应各种场合的使用要求。<br>
							&nbsp;&nbsp; 
							<b>我公司还生产各种系列的永磁除铁产品，如自卸式永磁除铁器、永磁轮、永磁辊、永磁板、还有矿石粉磁选机，专门用于从矿石粉（如长石粉）中分离铁粉杂质，提高原料的品位。永磁除铁产品的共同特点是：磁力大，节省能源，维护简单，使用寿命长。</b></td>
						</tr>
					</table>
				</div>
				</td>
			...
			<p align="center">
			<img border="0" src="images/03.gif" width="560" height="180"></td>
          </tr>
      </table>
				      </td>
					</tr>
