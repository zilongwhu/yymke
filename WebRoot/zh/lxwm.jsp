				      ...
				      <td width="210" style="background-color:#FFF;">
      					...
      					<td width="">
      						<table width="100%" border="0">
						        <tr>
						          <td><div style="width:92% auto; height:20px; position:relative;background-image:url(images/co.gif); background-repeat:no-repeat; background-color:#E1E2E6; margin-left:3px;"></div></td>
						        </tr>
						        <tr>
						          <td style="text-align:left; line-height:250%; padding-left:8px; padding-top:10px;"> <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;岳阳明科电气有限公司<br />
						            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地址：湖南省岳阳市麻塘镇洞庭村<br />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;邮编：414000<br />
						            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;电话：0730-7832001<br />
						            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;传真：0730-7832011</strong></td>
						        </tr>
						        <tr>
						          <td><div style="width:92% auto; height:20px; position:relative;background-image:url(images/p.gif); background-repeat:no-repeat; background-color:#E1E2E6; margin-left:3px;"></div></td>
						        </tr>
						        <tr>
						          <td>
						          	<table width="100%" border="0">
							            <tr>
							              <td><a href="product.jsp?id=1"><img src="images/p_1.jpg" alt="" width="300" height="66" border="0" /></a></td>
							              <td><a href="product.jsp?id=8"><img src="images/p_2.jpg" border="0" alt="" width="300" height="66" /></a></td>
							            </tr>
							            <tr>
							              <td style="text-align:left; line-height:200%; padding-left:13px; padding-right:6px;"><span style="text-align:left; line-height:200%; padding-left:13px; padding-right:10px; font-size:13px;"><strong><img src="images/xx.png" alt="" width="25" height="17" /><a href="product.jsp?id=1">起重电磁铁及电控系列</a></strong><br />
							&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:12px"><a href="product.jsp?id=1">吊运废钢用起重电磁铁；吊运钢坯、板坯用起重电磁铁；板坯吊运翻转用起重电磁铁；吊运钢锭、钢坯用起重电磁铁；吊运初扎钢、型钢用起重电磁铁；吊运钢坯、圆钢用起重电磁铁</a></span>......</span></td>
							              <td style="text-align:left; line-height:200%; padding-left:13px; padding-right:6px;"><span style="text-align:left; line-height:200%; padding-left:13px; padding-right:6px; font-size:13px;"><strong><img src="images/xx.png" alt="" width="25" height="17" /><a href="product.jsp?id=8">除铁器及电控系列</a></strong><br />
							&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:12px"><a href="product.jsp?id=8">MC03系列圆形电磁除铁器；MC23系列矩形电磁除铁器；MC22系列自卸式电磁除铁器；MC12系列自卸式电磁除铁器；MC12系列节能型自卸式电磁除铁器；RCDD-Q系列超强新型风冷自卸式电磁除铁器</a></span>......</span></td>
							            </tr>
							            <tr>
							          <td>&nbsp;</td>
							            </tr>
							            <tr>
							              <td><a href="product.jsp?id=9"><img src="images/p_3.jpg" border="0" alt="" width="300" height="66" /></a></td>
							              <td><a href="product.jsp?id=70"><img src="images/p_4.jpg" border="0" alt="" width="300" height="66" /></a></td>
							            </tr>
							            <tr>
							              <td style="text-align:left; line-height:200%; padding-left:13px; padding-right:6px;"><span style="text-align:left; line-height:200%; padding-left:13px; padding-right:10px;"><strong><img src="images/xx.png" alt="" width="25" height="17" /><a href="product.jsp?id=9">电缆卷筒系列</a></strong><br />
							&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:12px"><a href="product.jsp?id=9">弹力、力矩电机式电缆卷筒；弹力电缆卷筒滑环内装式；弹力电缆卷筒水平地面卷取式；弹力电缆卷筒滑环外装式；弹力电缆卷筒悬臂式；电缆卷筒信号式；电缆卷筒力矩电机式；重锤式电缆卷筒</a><span style="text-align:left; line-height:200%; padding-left:0px; padding-right:10px; font-size:13px;">......</span></span></span></td>
							              <td style="text-align:left; line-height:200%; padding-left:13px; padding-right:6px;"><strong><img src="images/xx.png" alt="" width="25" height="17" /><a href="product.jsp?id=70"><a href="product.jsp?id=70">连铸电磁搅拌装置系列</a></strong><br />
							                <span style="text-align:left; line-height:200%; padding-left:13px; padding-right:10px;">&nbsp;</span><a href="product.jsp?id=70">结晶器外置式电磁搅拌器(内冷)；结晶器外置式电磁搅拌器(外冷)；结晶器内置式电磁搅拌器(外冷)；结晶器内置式电磁搅拌器(模块)；结晶器内置式电磁搅拌器(两相两极)；双线圈结晶器电磁搅拌器</a><span style="text-align:left; line-height:200%; padding-left:0px; padding-right:10px; font-size:13px;">......</span></td>
							            </tr>
							          </table>
						          </td>
						        </tr>
