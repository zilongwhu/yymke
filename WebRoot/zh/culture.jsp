				    ...
				    <tr valign="top">
				      ...
				      <td width="">
				      	<table width="100%" border="0">
					        <tr>
					          <td><div style="width:92% auto; height:20px; position:relative;background-image:url(images/c.jpg); background-repeat:no-repeat; background-color:#E1E2E6; margin-left:3px;"></div></td>
					        </tr>
					        <tr>
					          <td style="text-align:left; line-height:200%; padding-left:32px; padding-top:12px;">
							<table>
								<tr>
									<td width=80px valign=top><b>企业愿景</b></td>
									<td>做行业领先者；</td>
								</tr>
								<tr>
					            			<td width=80px valign=top><b>企业使命</b></td>
									<td>关注客户需求，更安全、更有效，为客户持续创造价值；</td>
								</tr>
								<tr>
					            			<td width=80px valign=top><b>经营理念</b></td>
									<td>
										<table>
											<tr>
												<td width=80px valign=top><b>客户第一</b></td>
												<td>始于客户需求，终于客户需求，以客户为中心，永远致力于提升客户满意度，制造出更安全、更有效的电磁产品；</td>
											</tr>
											<tr>
												<td width=80px valign=top><b>学习创新</b></td>
												<td>不断学习改进，致力于产品和服务的创新、技术创新、经营管理创新，通过创新产生高附加值的产品和服务；</td>
											</tr>
											<tr>
												<td width=80px valign=top><b>诚信正直</b></td>
												<td>立信守城、公正行实、为人之道、经营之德；</td>
											</tr>
											<tr>
												<td width=80px valign=top><b>以人为本</b></td>
												<td>尊重个人，充分尊重员工的自我价值的实现；</td>
											</tr>
											<tr>
												<td width=80px valign=top><b>赢在细节</b></td>
												<td>注重每一个细节，做精品，树世界品牌；</td>
											</tr>
											<tr>
												<td width=80px valign=top><b>追求卓越</b></td>
												<td>关注行业发展，追求领先技术，永远致力于电磁技术创新！</td>
											</tr>
										</table>
									</td>
								</tr>
