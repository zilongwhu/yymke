				  ...
				  <table width="100%" cellpadding="0" cellspacing="0" border="0">
				    <tr valign="top">
				      ...
				      <td width="">
						...
						<tr><td>&nbsp;</td></tr>
						<tr align="left">
							<td><img border="0" src="images/01.gif" width="540" height="286"><br></td>
						</tr>
						<!-- MSTableType="layout" -->
						<tr align="left">
							<td height="22" valign="top">二、用途<br>
							1、MW1、MW5、MW61系列专门为吸运废钢铁而设计的电磁铁。<br>
							2、MW22、MW42、MW92系列电磁铁是专门为吸吊初轧钢坯型钢，方坯而设计的电磁铁。<br>
							3、MW03系列电磁铁专门为吸吊厚板而设计的，用于吸吊板坯。<br>
							4、MW73系列电磁铁用于板坯搬运兼翻转。<br>
							5、MW84、MW04系列电磁铁用于6 －32mm钢板搬运，MW84系列与控制设备配套可单张，多张作业；<br>
&nbsp;&nbsp; MW04系列只能单张作业。<br>
							6、MW15-口54L、MW22-口54L系列电磁铁用于吸吊捆扎螺纹钢、盘圆。<br>
							7、MW16、MW26、MW36、MW96系列电磁铁用于吸吊钢带卷。<br>
							8、MW12系列用于捆扎螺纹钢、捆扎钢管双层小方坯和圆钢。<br>
							9、MW85系列电磁铁用于吸吊大口径钢管。</td>
						</tr>
					</table>
					  </td>
					</tr>
